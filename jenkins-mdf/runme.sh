...
oc new-build https://github.com/thikade/dockerfiles.git --name=jenkins --strategy=docker  --context-dir=jenkins-mdf  --image-stream=jenkins-plugins:latest  --allow-missing-imagestream-tags
